  ...
  return (
    <Tab.Navigator screenOptions={SCREEN_OPTIONS}>
      <Tab.Screen
        ...
        options={{ tabBarIcon: ({ color }) => <IconPigOutline fill={color} /> }}
      />
      <Tab.Screen
        name="정기지출"
        component={DetailsScreen}
      ...
      <Tab.Screen
        name="가계부 통계"
        component={DetailsScreen}
        options={{ tabBarIcon: ({ color }) => <IconAccountOutline fill={color} /> }}
      />
      <Tab.Screen
        name="버킷리스트"
        component={DetailsScreen}
        options={{ tabBarIcon: ({ color }) => <IconBucketOutline fill={color} /> }}
      />
      <Tab.Screen
        name="내 정보"
        component={DetailsScreen}
